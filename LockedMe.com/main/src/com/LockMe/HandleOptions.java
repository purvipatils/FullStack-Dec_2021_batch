...
import com.LockMe.FileOperations;
import com.LockMe.HandleOptions;
import com.LockMe.LockMeMenu;

public interface HandleOptions {
	static void handleWelcomeScreenInput() {
		boolean running = true;
		Scanner sc = new Scanner(System.in);
		do {
			try {
				LockMeMenu.displayLockMeMenu();
